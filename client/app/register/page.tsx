  ...
  return (
    <main className="min-h-screen relative flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        ...
        >
          <h2 className="text-3xl font-space-grotesk text-center text-white mb-2">Create Account</h2>
          <p className="text-center text-gray-400 mb-8 font-inter">Join DevSync today</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="relative">
              ...
              />
              <label htmlFor="name" className="absolute left-2 -top-3 text-sm text-[var(--cyan-accent)] transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-placeholder-shown:top-3 peer-focus:-top-3 peer-focus:text-sm peer-focus:text-[var(--cyan-accent)] pointer-events-none">
                Full Name
              </label>
            </div>
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="mt-4 px-4 py-3 bg-[var(--cyan-accent)] text-black font-bold rounded shadow-lg hover:shadow-[0_0_15px_var(--cyan-accent)] transition-all"
            >
              Sign Up
            </motion.button>
          </form>
